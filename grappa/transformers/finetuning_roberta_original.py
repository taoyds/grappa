    ...
    if args.do_train:
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_dataloader):
                model.train()
                input_ids, input_mask, col_label_ids, lm_label_ids = batch
                input_ids, input_mask, col_label_ids, lm_label_ids = to_device(device, input_ids, input_mask, col_label_ids, lm_label_ids)
            ...
            if args.do_eval:
                ...
                for step, batch in enumerate(train_eval_dataloader):
                    model.eval()
                    input_ids, input_mask, col_label_ids, _ = batch
                    input_ids, input_mask, col_label_ids = to_device(device, input_ids, input_mask, col_label_ids)
                    with torch.no_grad():
            ...
            elif (epoch != 0 and epoch % 5 == 0) or epoch == 2:
