...
class RobertaForMaskedLM(BertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
                masked_lm_labels=None, masked_col_labels=None, q_tab_inds=None, is_train=True):
        ...
        if masked_col_labels is not None:
            ...
            weight_list = [0.3] + [1.]*(LABEL_COUNT-1)
        ...
        if is_train:
            ...
            return total_loss, (lm_prediction_scores, col_prediction_scores)
