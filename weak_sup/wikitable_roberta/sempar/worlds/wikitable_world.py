...
class WikiTablesVariableFreeWorld(World):
    ...
    curried_functions = {
            types.SELECT_TYPE: 2,
            types.BSELECT_TYPE: 2,
            types.ROW_FILTER_ARG: 2,
            types.ROW_FILTER_SAME: 2,
            types.ROW_NUM_OP: 2,
            ...
            types.ROW_FILTER_WITH_COLUMN_AND_NUMBER_EQ: 3,
            types.ROW_FILTER_WITH_COLUMN_AND_DATE_EQ: 3,
            types.ROW_FILTER_WITH_COLUMN_AND_STRING_EQ: 3,
    ...
    def get_basic_types(self) -> Set[Type]:
        ...
        basic_types.add(types.ROW_TYPE)
        basic_types.add(types.MUL_ROW_TYPE)
