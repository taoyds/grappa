...
MUL_ROW_TYPE = NamedBasicType("EROW")
...
GENERIC_ROW_TYPE = MultiMatchNamedBasicType("HROW", [ROW_TYPE, MUL_ROW_TYPE])
...
BASIC_TYPES = {GENERIC_ROW_TYPE, GENERIC_COLUMN_TYPE, NUMBER_TYPE, DATE_TYPE, STRING_TYPE}
STARTING_TYPES = {NUMBER_TYPE, DATE_TYPE, STRING_TYPE}

# Complex types
# Type for selecting the value i a column in a set of rows. "select" and "mode" functions.
SELECT_TYPE = ComplexType(GENERIC_ROW_TYPE, ComplexType(GENERIC_COLUMN_TYPE, STRING_TYPE))
BSELECT_TYPE = ComplexType(MUL_ROW_TYPE, ComplexType(GENERIC_COLUMN_TYPE, STRING_TYPE))
...
ROW_FILTER_SAME = ComplexType(ROW_TYPE, ComplexType(GENERIC_COLUMN_TYPE, MUL_ROW_TYPE))
ROW_FILTER_ARG = ComplexType(MUL_ROW_TYPE, ComplexType(COMPARABLE_COLUMN_TYPE, ROW_TYPE))

# "filter_number_greater", "filter_number_equals" etc.
ROW_FILTER_WITH_COLUMN_AND_NUMBER = ComplexType(MUL_ROW_TYPE,
                                                ComplexType(NUMBER_COLUMN_TYPE,
                                                            ComplexType(NUMBER_TYPE, MUL_ROW_TYPE)))
ROW_FILTER_WITH_COLUMN_AND_NUMBER_EQ = ComplexType(MUL_ROW_TYPE,
                                                ComplexType(NUMBER_COLUMN_TYPE,
                                                            ComplexType(NUMBER_TYPE, GENERIC_ROW_TYPE)))

# "filter_date_greater", "filter_date_equals" etc.
ROW_FILTER_WITH_COLUMN_AND_DATE = ComplexType(MUL_ROW_TYPE,
                                              ComplexType(DATE_COLUMN_TYPE,
                                                          ComplexType(DATE_TYPE, MUL_ROW_TYPE)))
ROW_FILTER_WITH_COLUMN_AND_DATE_EQ = ComplexType(MUL_ROW_TYPE,
                                              ComplexType(DATE_COLUMN_TYPE,
                                                          ComplexType(DATE_TYPE, GENERIC_ROW_TYPE)))

# "filter_in" and "filter_not_in"
ROW_FILTER_WITH_COLUMN_AND_STRING = ComplexType(MUL_ROW_TYPE,
                                                ComplexType(STRING_COLUMN_TYPE,
                                                            ComplexType(STRING_TYPE, MUL_ROW_TYPE)))
ROW_FILTER_WITH_COLUMN_AND_STRING_EQ = ComplexType(MUL_ROW_TYPE,
                                                ComplexType(STRING_COLUMN_TYPE,
                                                            ComplexType(STRING_TYPE, GENERIC_ROW_TYPE)))

ROW_FILTER = ComplexType(ROW_TYPE, ROW_TYPE)  # previous, next etc.
MROW_FILTER = ComplexType(MUL_ROW_TYPE, ROW_TYPE)  # last, first etc.

# This language lets you count only rows!
COUNT_TYPE = ComplexType(MUL_ROW_TYPE, NUMBER_TYPE)

# Numerical operations on numbers in the given column. "max", "min", "sum", "average" etc.
ROW_NUM_OP = ComplexType(MUL_ROW_TYPE, ComplexType(NUMBER_COLUMN_TYPE, NUMBER_TYPE))
...
generic_name_mapper.map_name_with_signature("all_rows", MUL_ROW_TYPE)
generic_name_mapper.map_name_with_signature("mul_rows_select", MUL_ROW_TYPE)
generic_name_mapper.map_name_with_signature("one_row_select", ROW_TYPE)

# <r,<g,s>>
generic_name_mapper.map_name_with_signature("select", SELECT_TYPE)
generic_name_mapper.map_name_with_signature("mode", BSELECT_TYPE)

# <r,<c,r>>
comparable_column_name_mapper.map_name_with_signature("argmax", ROW_FILTER_ARG)
comparable_column_name_mapper.map_name_with_signature("argmin", ROW_FILTER_ARG)

# <r,<g,r>>
generic_name_mapper.map_name_with_signature("same_as", ROW_FILTER_SAME)
...
number_column_name_mapper.map_name_with_signature("filter_number_equals", ROW_FILTER_WITH_COLUMN_AND_NUMBER_EQ)
...
date_column_name_mapper.map_name_with_signature("filter_date_equals", ROW_FILTER_WITH_COLUMN_AND_DATE_EQ)
date_column_name_mapper.map_name_with_signature("filter_date_not_equals", ROW_FILTER_WITH_COLUMN_AND_DATE)

# <r,<t,<s,r>>>
string_column_name_mapper.map_name_with_signature("filter_in", ROW_FILTER_WITH_COLUMN_AND_STRING_EQ)
string_column_name_mapper.map_name_with_signature("filter_not_in", ROW_FILTER_WITH_COLUMN_AND_STRING)

# <r,r>
generic_name_mapper.map_name_with_signature("first", MROW_FILTER)
generic_name_mapper.map_name_with_signature("last", MROW_FILTER)
